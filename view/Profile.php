    				...
    				<div id="myModal" class="modal fade" role="dialog">
                      ...
                      if (isset($_POST['sub'])) {
												...
												if ($bfn == '') {
													...
													$update = "update admin set recovery_account='$bfn' where user_id='$user_id'";
...
if (isset($_POST['update'])) {
  ...
  if ($f_name == '') {
    ...
    elseif ($u_email=='') {
     ...
     $update = "update admin set f_name='$f_name',l_name='$l_name',user_name='$u_name', Relationship='$Relationship_status',user_pass='$u_pass',user_email='$u_email',user_counrey='$u_country',user_gender='$u_gender',user_birthday='$u_birthday' where user_id='$user_id'";
     $run= mysqli_query($con,$update);
      if ($run) {
